...
class _HealthScreenState extends State<HealthScreen>
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Choose a time range to generate a PDF report',
              ...
              _ExportRangeButton(
                ...
                onTap: () => _doExport(context, ExportRange.week),
              ),
              ...
              _ExportRangeButton(
                ...
                onTap: () => _doExport(context, ExportRange.month),
              ),
              const SizedBox(height: 10),
              _ExportRangeButton(
                ...
                onTap: () => _doExport(context, ExportRange.year),
              ),
            ],
          ),
        );
  ...
  Future<void> _doExport(BuildContext context, ExportRange range) async {
    ...
    try {
      await PdfExportService.exportAndShare(
        username: auth.currentUser?.username ?? 'User',
        range: range,
        sessions: activity.userSessions,
