...
class AppColors {
  ...
  // Dark Theme Colors — pitch black + #C7EABB sage green
  static const Color darkBackground = Color(0xFF000000);
  static const Color darkForeground = Color(0xFFC7EABB);
  static const Color darkCard = Color(0xFF0D0D0D);
  static const Color darkCardForeground = Color(0xFFC7EABB);
  static const Color darkPopover = Color(0xFF0D0D0D);
  static const Color darkPopoverForeground = Color(0xFFC7EABB);
  static const Color darkPrimary = Color(0xFFC7EABB);
  static const Color darkPrimaryForeground = Color(0xFF000000);
  static const Color darkSecondary = Color(0xFF0D1A0D);
  static const Color darkSecondaryForeground = Color(0xFFC7EABB);
  static const Color darkMuted = Color(0xFF0A0A0A);
  static const Color darkMutedForeground = Color(0xFF8FB88A);
  static const Color darkAccent = Color(0xFF162416);
  static const Color darkAccentForeground = Color(0xFFC7EABB);
  static const Color darkDestructive = Color(0xFFef4444);
  static const Color darkDestructiveForeground = Color(0xFFffffff);
  static const Color darkBorder = Color(0xFF1E2E1E);
  static const Color darkInput = Color(0xFF1E2E1E);
  static const Color darkRing = Color(0xFFC7EABB);
}
  ...
  static TextTheme _buildTextTheme(
    ...
    return GoogleFonts.lexendTextTheme(base).copyWith(
      ...
      bodyLarge: GoogleFonts.lexend(
        textStyle: base.bodyLarge?.copyWith(letterSpacing: 0, color: baseColor),
      ),
